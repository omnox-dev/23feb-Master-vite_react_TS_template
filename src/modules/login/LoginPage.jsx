...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center p-6 animate-in fade-in duration-700">
      {/* Login Card */}
      <div className="glass-card w-full max-w-xl p-12 flex flex-col items-center relative overflow-hidden">
        ...
        {/* Welcome Header */}
        <h1 className="text-5xl font-black text-current mb-3 tracking-tight">Welcome Back</h1>
        ...
        <form className="w-full space-y-8">
          <div className="relative group">
            ...
            <input 
              ...
              placeholder="INPUT FIELDS: TEAMMATE DOMAIN" 
              type="text"
            />
          </div>
        ...
        <div className="mt-12 text-sm opacity-60 font-medium">
          Don't have an account? <NavLink to="/register" className="text-brand-blue hover:underline">Register Now</NavLink>
        </div>
